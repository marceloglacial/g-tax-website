...
const Contact = () => {
  return (
    <section id="contato" className="pt-32 pb-0">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:max-w-5xl mx-auto md:p-20">
          <div className="grid gap-12">
            <Animation delay={0.6} className="text-xl">
              Descubra como podemos ajudá-lo a manter sua vida financeira em
              ordem enquanto você aproveita as oportunidades que o Canadá
              oferece!
            </Animation>
            <Animation delay={0.7} className="flex flex-col gap-2 text-2xl">
            ...
            <Animation delay={0.8} className="flex flex-col gap-2 text-2xl">
              <div className="flex gap-2 items-center">
            ...
            <Animation delay={0.9} className="flex flex-col gap-2 text-2xl">
              <div className="flex gap-2 items-center">
                <Building className=" text-accent" />
