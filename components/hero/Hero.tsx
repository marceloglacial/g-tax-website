...
const Hero = ({
  ...
  return (
    <section
      id="hero"
      className="py-20 lg:py-32 lg:h-screen lg:flex lg:items-center bg-[url(/hero-bg.png)] bg-bottom lg:bg-right bg-[length:100%_auto] lg:bg-[length:50%_auto] bg-no-repeat"
    >
      <Animation>
